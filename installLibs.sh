...
## sudo permissions require permission for "/root" location
if [ -d ~/.Xilinx/xinstall ]; then
   logFile=~/.Xilinx/xinstall/${scriptName}_${tstamp}
else
   logFile=/var/log/${scriptName}_${tstamp}
fi
